SET DATE ITALIAN
SET CENTURY ON
SET PATH TO C:\FWSU\FORMS;C:\FWSU\PRG;C:\FWSU\CLASES;F:\SUELDOS\EMPRE2;F:\SUELDOS
SET EXCLUSIVE OFF
...
SELECT l.legajo,l.nombre,l.documento,s.desde,s.hasta,s.dias,s.ano FROM personal l INNER JOIN vacaci s ON l.legajo = Varlegajo AND s.legajo =Varlegajo  AND s.ano = 2019 into CURSOR vacaciones
