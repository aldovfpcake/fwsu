...
SELECT l.legajo,l.nombre,l.documento,s.desde,s.hasta,s.dias,s.ano FROM personal l INNER JOIN vacaci s ON l.legajo = Varlegajo AND s.legajo =Varlegajo  AND s.ano = 2018 into CURSOR vacaciones
