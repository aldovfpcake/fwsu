...
FOR I = 1 TO 11
 ...
 FOR x = 1 TO  12
    ...
    ?archivo
   IF FILE(archivo + '.dbf')
     SELECT SUM(aporte) as aporte ,SUM(sinaporte) as sinaporte, SUM(IIF(CONCEPTO <> 130,DESCUENTO,0))as descuento,liquida FROM &archivo WHERE legajo = 456 GROUP BY liquida INTO CURSOR liquida
