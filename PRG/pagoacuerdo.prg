...
SCAN
    SELECT CONCEPTO FROM 112019 WHERE CONCEPTO = 448 .AND. LIQUIDA = 1 .AND. LEGAJO = LISTADOACUER.LEGAJO;
    INTO CURSOR EXISTE	
    
    IF EOF()
       INSERT INTO 112019 (LEGAJO,CONCEPTO,DESCRIP,SINAPORTE,LIQUIDA) VALUES (LISTADOACUER.LEGAJO,448,"Decreto 665/19",2500,1)
    ELSE 
       UPDATE 112019 SET DESCRIP = "Decreto 665/19" ;
