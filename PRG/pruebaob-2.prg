...
Vartotal    = informe2.s3+  informe2.s2 + informe2.s1+ informe.s10+ informe.s11+informe.s12
VarPromedio = ROUND((informe2.s3+ informe2.s2+ informe2.s1+ informe.s10+ informe.s11+informe.s12)/6,2)
