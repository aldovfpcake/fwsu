...
FROM 32017 WHERE LIQUIDA = 3  GROUP BY LEGAJO INTO CURSOR ONE
**
* VERIFICAR FECHA DE INGRESO
*
SELECT P.LEGAJO,P.FECHAING,P.NOMBRE,P.CUIL, P.DEPART,P.SUELDOFIJO,P.CATEGORIA FROM PERSONAL AS P WHERE ACTIVO = "A" .AND. FECHAING < CTOD("01-03-2017") INTO CURSOR PACTIVO
