...
DO WHILE .NOT. EOF()
  ...
  *                                 123456798-123456789-123456789       
  ...
  @LIN, 42  SAY HIJOS      PICTURE "9"
  @LIN, 43  SAY "0"  
  @LIN, 44  SAY CODSITU   PICTURE "!"
  @LIN, 45  SAY "0"
  @LIN, 46  SAY CONDICION PICTURE "!"
  @LIN, 48  SAY "0"
  @LIN, 49  SAY ACTIVIDAD PICTURE "!!!"
  *@LIN, 48  SAY ACTIVIDAD PICTURE "0"+"49"
  @LIN, 51  SAY ZONA      PICTURE "!!"
  @LIN, 53  SAY "00000"
