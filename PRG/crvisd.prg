...
DBSetProp("curliq","View","Tables","112014")
DBSetProp("curliq","View","WhereType",3)

DBSetProp("curliq"+".legajo","Field","DataType","N(4)")
DBSetProp("curliq"+".legajo","Field","UpdateName","112014.legajo")
...
DBSetProp("curliq"+".concepto","Field","UpdateName","112014.concepto")
...
DBSetProp("curliq"+".tipoconcep","Field","UpdateName","112014.tipoconcep")
...
DBSetProp("curliq"+".valoruni","Field","UpdateName","112014.valoruni")
...
DBSetProp("curliq"+".cantidad","Field","UpdateName","112014.cantidad")
...
DBSetProp("curliq"+".aporte","Field","UpdateName","112014.aporte")
...
DBSetProp("curliq"+".sinaporte","Field","UpdateName","112014.sinaporte")
...
DBSetProp("curliq"+".descuento","Field","UpdateName","112014.descuento")
...
DBSetProp("curliq"+".liquida","Field","UpdateName","112014.liquida")
...
DBSetProp("curliq"+".recibo","Field","UpdateName","112014.recibo")
...
DBSetProp("curliq"+".descrip","Field","UpdateName","112014.descrip")
...
DBSetProp("curliq"+".orden","Field","UpdateName","112014.orden")
