...
DBSetProp("curliq","View","Tables","32020")
DBSetProp("curliq","View","WhereType",3)

DBSetProp("curliq"+".legajo","Field","DataType","N(4)")
DBSetProp("curliq"+".legajo","Field","UpdateName","32020.legajo")
...
DBSetProp("curliq"+".concepto","Field","UpdateName","32020.concepto")
...
DBSetProp("curliq"+".tipoconcep","Field","UpdateName","32020.tipoconcep")
...
DBSetProp("curliq"+".valoruni","Field","UpdateName","32020.valoruni")
...
DBSetProp("curliq"+".cantidad","Field","UpdateName","32020.cantidad")
...
DBSetProp("curliq"+".aporte","Field","UpdateName","32020.aporte")
...
DBSetProp("curliq"+".sinaporte","Field","UpdateName","32020.sinaporte")
...
DBSetProp("curliq"+".descuento","Field","UpdateName","32020.descuento")
...
DBSetProp("curliq"+".liquida","Field","UpdateName","32020.liquida")
...
DBSetProp("curliq"+".recibo","Field","UpdateName","32020.recibo")
...
DBSetProp("curliq"+".descrip","Field","UpdateName","32020.descrip")
...
DBSetProp("curliq"+".orden","Field","UpdateName","32020.orden")
