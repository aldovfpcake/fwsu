...
DBSetProp("curliq","View","Tables","12020")
DBSetProp("curliq","View","WhereType",3)

DBSetProp("curliq"+".legajo","Field","DataType","N(4)")
DBSetProp("curliq"+".legajo","Field","UpdateName","12020.legajo")
...
DBSetProp("curliq"+".concepto","Field","UpdateName","12020.concepto")
...
DBSetProp("curliq"+".tipoconcep","Field","UpdateName","12020.tipoconcep")
...
DBSetProp("curliq"+".valoruni","Field","UpdateName","12020.valoruni")
...
DBSetProp("curliq"+".cantidad","Field","UpdateName","12020.cantidad")
...
DBSetProp("curliq"+".aporte","Field","UpdateName","12020.aporte")
...
DBSetProp("curliq"+".sinaporte","Field","UpdateName","12020.sinaporte")
...
DBSetProp("curliq"+".descuento","Field","UpdateName","12020.descuento")
...
DBSetProp("curliq"+".liquida","Field","UpdateName","12020.liquida")
...
DBSetProp("curliq"+".recibo","Field","UpdateName","12020.recibo")
...
DBSetProp("curliq"+".descrip","Field","UpdateName","12020.descrip")
...
DBSetProp("curliq"+".orden","Field","UpdateName","12020.orden")
