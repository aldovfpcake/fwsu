...
DBSetProp("curliq","View","Tables","72020")
DBSetProp("curliq","View","WhereType",3)

DBSetProp("curliq"+".legajo","Field","DataType","N(4)")
DBSetProp("curliq"+".legajo","Field","UpdateName","72020.legajo")
...
DBSetProp("curliq"+".concepto","Field","UpdateName","72020.concepto")
...
DBSetProp("curliq"+".tipoconcep","Field","UpdateName","72020.tipoconcep")
...
DBSetProp("curliq"+".valoruni","Field","UpdateName","72020.valoruni")
...
DBSetProp("curliq"+".cantidad","Field","UpdateName","72020.cantidad")
...
DBSetProp("curliq"+".aporte","Field","UpdateName","72020.aporte")
...
DBSetProp("curliq"+".sinaporte","Field","UpdateName","72020.sinaporte")
...
DBSetProp("curliq"+".descuento","Field","UpdateName","72020.descuento")
...
DBSetProp("curliq"+".liquida","Field","UpdateName","72020.liquida")
...
DBSetProp("curliq"+".recibo","Field","UpdateName","72020.recibo")
...
DBSetProp("curliq"+".descrip","Field","UpdateName","72020.descrip")
...
DBSetProp("curliq"+".orden","Field","UpdateName","72020.orden")
