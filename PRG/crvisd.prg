...
DBSetProp("curliq","View","Tables","12019")
DBSetProp("curliq","View","WhereType",3)

DBSetProp("curliq"+".legajo","Field","DataType","N(4)")
DBSetProp("curliq"+".legajo","Field","UpdateName","12019.legajo")
...
DBSetProp("curliq"+".concepto","Field","UpdateName","12019.concepto")
...
DBSetProp("curliq"+".tipoconcep","Field","UpdateName","12019.tipoconcep")
...
DBSetProp("curliq"+".valoruni","Field","UpdateName","12019.valoruni")
...
DBSetProp("curliq"+".cantidad","Field","UpdateName","12019.cantidad")
...
DBSetProp("curliq"+".aporte","Field","UpdateName","12019.aporte")
...
DBSetProp("curliq"+".sinaporte","Field","UpdateName","12019.sinaporte")
...
DBSetProp("curliq"+".descuento","Field","UpdateName","12019.descuento")
...
DBSetProp("curliq"+".liquida","Field","UpdateName","12019.liquida")
...
DBSetProp("curliq"+".recibo","Field","UpdateName","12019.recibo")
...
DBSetProp("curliq"+".descrip","Field","UpdateName","12019.descrip")
...
DBSetProp("curliq"+".orden","Field","UpdateName","12019.orden")
