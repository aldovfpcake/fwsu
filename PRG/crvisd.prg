...
archivo = "F:\sueldos\empre1\B62014"
USE &archivo
...
DBSetProp("curliq","View","Tables","B62014")
DBSetProp("curliq","View","WhereType",3)

DBSetProp("curliq"+".legajo","Field","DataType","N(4)")
DBSetProp("curliq"+".legajo","Field","UpdateName","B62014.legajo")
...
DBSetProp("curliq"+".concepto","Field","UpdateName","B62014.concepto")
...
DBSetProp("curliq"+".tipoconcep","Field","UpdateName","B62014.tipoconcep")
...
DBSetProp("curliq"+".valoruni","Field","UpdateName","B62014.valoruni")
...
DBSetProp("curliq"+".cantidad","Field","UpdateName","B62014.cantidad")
...
DBSetProp("curliq"+".aporte","Field","UpdateName","B62014.aporte")
...
DBSetProp("curliq"+".sinaporte","Field","UpdateName","B62014.sinaporte")
...
DBSetProp("curliq"+".descuento","Field","UpdateName","B62014.descuento")
...
DBSetProp("curliq"+".liquida","Field","UpdateName","B62014.liquida")
...
DBSetProp("curliq"+".recibo","Field","UpdateName","B62014.recibo")
...
DBSetProp("curliq"+".descrip","Field","UpdateName","B62014.descrip")
...
DBSetProp("curliq"+".orden","Field","UpdateName","B62014.orden")
