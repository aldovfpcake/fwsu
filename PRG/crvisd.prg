...
DBSetProp("curliq","View","Tables","32019")
DBSetProp("curliq","View","WhereType",3)

DBSetProp("curliq"+".legajo","Field","DataType","N(4)")
DBSetProp("curliq"+".legajo","Field","UpdateName","32019.legajo")
...
DBSetProp("curliq"+".concepto","Field","UpdateName","32019.concepto")
...
DBSetProp("curliq"+".tipoconcep","Field","UpdateName","32019.tipoconcep")
...
DBSetProp("curliq"+".valoruni","Field","UpdateName","32019.valoruni")
...
DBSetProp("curliq"+".cantidad","Field","UpdateName","32019.cantidad")
...
DBSetProp("curliq"+".aporte","Field","UpdateName","32019.aporte")
...
DBSetProp("curliq"+".sinaporte","Field","UpdateName","32019.sinaporte")
...
DBSetProp("curliq"+".descuento","Field","UpdateName","32019.descuento")
...
DBSetProp("curliq"+".liquida","Field","UpdateName","32019.liquida")
...
DBSetProp("curliq"+".recibo","Field","UpdateName","32019.recibo")
...
DBSetProp("curliq"+".descrip","Field","UpdateName","32019.descrip")
...
DBSetProp("curliq"+".orden","Field","UpdateName","32019.orden")
