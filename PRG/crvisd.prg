...
DBSetProp("curliq","View","Tables","72017")
DBSetProp("curliq","View","WhereType",3)

DBSetProp("curliq"+".legajo","Field","DataType","N(4)")
DBSetProp("curliq"+".legajo","Field","UpdateName","72017.legajo")
...
DBSetProp("curliq"+".concepto","Field","UpdateName","72017.concepto")
...
DBSetProp("curliq"+".tipoconcep","Field","UpdateName","72017.tipoconcep")
...
DBSetProp("curliq"+".valoruni","Field","UpdateName","72017.valoruni")
...
DBSetProp("curliq"+".cantidad","Field","UpdateName","72017.cantidad")
...
DBSetProp("curliq"+".aporte","Field","UpdateName","72017.aporte")
...
DBSetProp("curliq"+".sinaporte","Field","UpdateName","72017.sinaporte")
...
DBSetProp("curliq"+".descuento","Field","UpdateName","72017.descuento")
...
DBSetProp("curliq"+".liquida","Field","UpdateName","72017.liquida")
...
DBSetProp("curliq"+".recibo","Field","UpdateName","72017.recibo")
...
DBSetProp("curliq"+".descrip","Field","UpdateName","72017.descrip")
...
DBSetProp("curliq"+".orden","Field","UpdateName","72017.orden")
