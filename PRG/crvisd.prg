...
DBSetProp("curliq","View","Tables","112018")
DBSetProp("curliq","View","WhereType",3)

DBSetProp("curliq"+".legajo","Field","DataType","N(4)")
DBSetProp("curliq"+".legajo","Field","UpdateName","112018.legajo")
...
DBSetProp("curliq"+".concepto","Field","UpdateName","112018.concepto")
...
DBSetProp("curliq"+".tipoconcep","Field","UpdateName","112018.tipoconcep")
...
DBSetProp("curliq"+".valoruni","Field","UpdateName","112018.valoruni")
...
DBSetProp("curliq"+".cantidad","Field","UpdateName","112018.cantidad")
...
DBSetProp("curliq"+".aporte","Field","UpdateName","112018.aporte")
...
DBSetProp("curliq"+".sinaporte","Field","UpdateName","112018.sinaporte")
...
DBSetProp("curliq"+".descuento","Field","UpdateName","112018.descuento")
...
DBSetProp("curliq"+".liquida","Field","UpdateName","112018.liquida")
...
DBSetProp("curliq"+".recibo","Field","UpdateName","112018.recibo")
...
DBSetProp("curliq"+".descrip","Field","UpdateName","112018.descrip")
...
DBSetProp("curliq"+".orden","Field","UpdateName","112018.orden")
