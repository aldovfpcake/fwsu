...
DBSetProp("curliq","View","Tables","52015")
DBSetProp("curliq","View","WhereType",3)

DBSetProp("curliq"+".legajo","Field","DataType","N(4)")
DBSetProp("curliq"+".legajo","Field","UpdateName","52015.legajo")
...
DBSetProp("curliq"+".concepto","Field","UpdateName","52015.concepto")
...
DBSetProp("curliq"+".tipoconcep","Field","UpdateName","52015.tipoconcep")
...
DBSetProp("curliq"+".valoruni","Field","UpdateName","52015.valoruni")
...
DBSetProp("curliq"+".cantidad","Field","UpdateName","52015.cantidad")
...
DBSetProp("curliq"+".aporte","Field","UpdateName","52015.aporte")
...
DBSetProp("curliq"+".sinaporte","Field","UpdateName","52015.sinaporte")
...
DBSetProp("curliq"+".descuento","Field","UpdateName","52015.descuento")
...
DBSetProp("curliq"+".liquida","Field","UpdateName","52015.liquida")
...
DBSetProp("curliq"+".recibo","Field","UpdateName","52015.recibo")
...
DBSetProp("curliq"+".descrip","Field","UpdateName","52015.descrip")
...
DBSetProp("curliq"+".orden","Field","UpdateName","52015.orden")
